...
const CreatePage = () => {
  ...
  const formatDateForInput = (date: Date) => date.toISOString().slice(0, 16); // Removes seconds and "Z"
  const [quiz, setQuiz] = useState<Quiz>({
    ...
    totalScore: 0,
    timeLimit: 120,
    dateOpens: formatDateForInput(new Date()), // Default to now
    dateCloses: formatDateForInput(new Date(2045, 10, 11, 18, 11, 11)),
